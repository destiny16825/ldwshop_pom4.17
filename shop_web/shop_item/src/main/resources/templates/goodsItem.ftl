...
<div class="shop_goods_bd clear">
    ...
    <div class="shop_goods_show">
        <div class="shop_goods_show_left">
            ...
            <div id="preview">
                <div class=jqzoom id="spec-n1" onClick="window.open('/')"><IMG height="350" src="http://192.168.72.128/${images[0]}" jqimg="http://192.168.72.128/${images[0]}" width="350">
                </div>
                <div id="spec-n5">
                    ...
                    <div id="spec-list">
                        <ul class="list-h">
                            <#list images as image >
                                <li><img src="http://192.168.72.128/${image}"></li>
                            </#list>
                        </ul>
                    </div>
        ...
        <div class="shop_goods_show_right">
            <ul>
                <li>
                    <strong style="font-size:14px; font-weight:bold;">${goods.goodName}</strong>
                </li>
                <li>
                    <label>价格：</label>
                    <span><strong>${goods.goodPrice?string("￥#,###.##")}</strong>元</span>
                </li>
                <li>
                    <label>运费：</label>
                    <span>卖家承担运费</span>
